...
class AppColors {
  ...
  static const Color userCardBackground = Color(0xFF2C2C2E);
  static const Color balanceCardBackground = Color(0xFF1D1D1F);
  static const Color searchBarBackground = Color(0xFF2C2C2E);
  static const Color searchBarHint = Color(0xFF8E8E93);

  // --- Feature Cards ---
  static const Color groceryCardColor = Color(0xFF8B6914); // Golden brown
  static const Color suggestionCardColor = Color(0xFF1E3A8A); // Blue
  static const Color askCardColor = Color(0xFF166534); // Green
